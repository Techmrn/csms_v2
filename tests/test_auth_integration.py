...
async def test_authenticated_identity_is_server_derived(client, dev_tokens):
    ...
    payload={"purchase_date":"2026-04-01","financial_year_id":1,"store_id":1,"lines":[{"item_id":1,"quantity":1,"unit_id":1}]}
...
async def test_receipt_store_scope(client, dev_tokens):
    ...
    payload={"receipt_date":"2026-04-01","financial_year_id":1,"store_id":1,"lines":[{"item_id":1,"received_quantity":1,"unit_id":1}]}
