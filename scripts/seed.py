...
ROLE_PERMISSIONS = {
    ...
    "DEPUTY_SUPDT_STORES": [
        ...
        "STOCK_UNSERVICEABLE_AUTHORIZE", "REQUISITION_APPROVE_CENTRAL",
        "REPORT_VIEW", "AUDIT_VIEW", "ASSET_VIEW",
    ],
    "GENERAL_STOREKEEPER": [
        "STOCK_VIEW", "STOCK_RECEIPT", "STOCK_ISSUE",
        "STOCK_TRANSFER_DISPATCH", "STOCK_RETURN", "INDENT_PROCESS",
        "REQUISITION_CREATE", "ASSET_VIEW", "ASSET_CREATE",
    ],
    ...
    "BRANCH_HEAD": [
        "STOCK_VIEW", "STOCK_VERIFY", "INDENT_APPROVE",
        "REQUISITION_APPROVE_BRANCH", "REPORT_VIEW", "ASSET_VIEW",
    ],
    "BRANCH_STOREKEEPER": [
        "STOCK_VIEW", "STOCK_RECEIPT", "STOCK_ISSUE",
